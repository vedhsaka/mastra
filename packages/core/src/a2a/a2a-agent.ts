...
type A2AAgentFinishPayload = {
  // Matches the regular Agent `finish` chunk shape so downstream consumers
  // (e.g. @mastra/ai-sdk's transformAgent) can treat both streams uniformly.
  stepResult: {
    reason: 'stop';
  };
  output: {
